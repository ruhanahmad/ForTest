import 'package:flutterappfood/login.dart';
import 'package:lottie/lottie.dart';

import 'FoodOrderMain.dart';
  ...
  Future checkFirstSeen() async {
    ...
    if (_seen) {
      Navigator.of(context).pushReplacement(
          new MaterialPageRoute(builder: (context) => new BottomNav()));
    } else {
      ...
      child: Scaffold(
        ...
        bottomSheet: slideIndex != 2 ? Container(
          ...
          child: Container(
            ...
            child: Text(
              "GET STARTED NOW",
              style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600,fontSize: 22,fontFamily: 'Cuprum'),
            ),
          ),
        ),
      ),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            bottom: 0 ,
           child:Lottie.asset(imagePath,repeat: false,height: 500,width: 500) ,
          ...
          Positioned(
            ...
            right: 0,
            bottom: 0 ,
            child:Text(desc,style: TextStyle(fontFamily: 'cuprum',fontSize: 30,color: Colors.white),) ,
